  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div class="container mt-5">
        <h1 class="text-center mt-4 mb-5 display-4 fw-bolder text-primary">Announcements</h1>
        <div>
          <div>
            <div class="d-flex justify-content-end mb-3">
              <button class="btn btn-primary px-5" data-bs-toggle="modal" data-bs-target="#addAnnouncementModal">Add Announcement</button>
            </div>
            <div class="table-responsive">
              <table class="table table-hover rounded-4 overflow-hidden shadow">
                <thead class="table-info">
                  <tr>
                    <th scope="col" class="text-primary py-4" style="width: 60%;">Announcement Title</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="py-4">
                      <a href="{{ route('edit_announcement') }}" class="btn btn-primary btn-sm px-3 me-2">Edit</a>
        ...
        <div class="modal-dialog modal-fullscreen-md-down modal-lg modal-xl">
          <div class="modal-content">
            <div class="modal-header justify-content-center">
              <h5 class="modal-title fw-bold fs-1 text-primary text-center" id="addAnnouncementModalLabel">Create Announcement</h5>
              <button type="button" class="btn-close position-absolute end-0 me-3" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <form>
                <div class="mb-3">
                  <label for="announcementTitle" class="form-label fw-bold fs-5">Announcement Title:</label>
                  <input type="text" class="form-control" id="announcementTitle" placeholder="Enter announcement title">
                </div>
                <div class="mb-3">
                  <label for="announcementDescription" class="form-label fw-bold fs-5">Description:</label>
                  <textarea class="form-control" id="announcementDescription" rows="8" placeholder="Enter description"></textarea>
                </div>
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label for="announcementDate" class="form-label fw-bold fs-5">Announcement Date:</label>
