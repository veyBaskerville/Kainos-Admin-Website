        ...
        <div>
          <form>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="faqQuestion" placeholder="Enter FAQ question" value="Existing FAQ Question">
            </div>
            <div class="mb-3">
              <label for="faqAnswer" class="form-label fw-bold fs-5">Answer:</label>
              <textarea class="form-control" id="faqAnswer" rows="8" placeholder="Enter answer">Existing answer...</textarea>
            </div>
            <div class="mb-3">
              <label for="faqDate" class="form-label fw-bold fs-5">Date:</label>
              <input type="date" class="form-control" id="faqDate" placeholder="Enter date">
            </div>
            <div class="d-flex justify-content-center mt-5">
              <a href="{{ route('publish.faqs') }}" class="btn btn-secondary me-3" style="width: 15%;">Cancel</a>
