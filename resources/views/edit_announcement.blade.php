...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <h1 class="text-center mt-4 mb-5 display-4 fw-bolder text-primary">Edit Announcement</h1>
      <div>
        <div>
          <form>
            <div class="mb-3">
              <label for="announcementTitle" class="form-label fw-bold fs-5">Announcement Title:</label>
              <input type="text" class="form-control" id="announcementTitle" placeholder="Enter announcement title" value="Existing Announcement Title">
            </div>
            <div class="mb-3">
              <label for="announcementDescription" class="form-label fw-bold fs-5">Description:</label>
              <textarea class="form-control" id="announcementDescription" rows="8" placeholder="Enter description">Existing description...</textarea>
            </div>
            <div class="row pb-3">
              <div class="col-md-6">
                <label for="announcementDate" class="form-label fw-bold fs-5">Announcement Date:</label>
                <input type="date" class="form-control" id="announcementDate" value="2024-09-10">
              </div>
            ...
            <div class="d-flex justify-content-center mt-5">
              <a href="{{ route('publish.announcement') }}" class="btn btn-secondary me-3" style="width: 15%;">Cancel</a>
