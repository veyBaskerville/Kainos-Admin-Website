            ...
            <div class="table-responsive">
              <table class="table table-hover rounded-4 overflow-hidden shadow">
                <thead class="table-info">
                  <tr>
                    <th scope="col" class="text-primary py-4" style="width: 70%;">Question</th>
                ...
                <tbody>
                  <tr>
                    <td class="py-4">What are the requirements for a barangay clearance?</td>
                    <td class="py-4">07 / 20 / 2024</td>
                    <td class="py-4">
                      <a href="{{ route('edit_faq') }}" class="btn btn-primary btn-sm px-3 me-2">Edit</a>
                      <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</button>
                    </td>
                  </tr>
                  <tr>
                    <td class="py-4">How can I file a complaint?</td>
                  ...
                  <tr>
                    <td class="py-4">What is the process for requesting a document?</td>
        ...
        <div class="modal-dialog modal-fullscreen-md-down modal-lg modal-xl">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form>
                <div class="mb-3">
                  <label for="faqQuestion" class="form-label fw-bold fs-5">Question:</label>
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="faqAnswer" rows="8" placeholder="Enter answer"></textarea>
                </div>
                <div class="mb-3">
                  <label for="faqDate" class="form-label fw-bold fs-5">Date:</label>
                  <input type="date" class="form-control" id="faqDate">
                </div>
              </form>
            </div>
