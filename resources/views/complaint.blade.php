      ...
      <main class="main-content">
        <div class="container mt-5 pt-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <option selected>All Complaint</option>
                ...
                <option value="4">Phase 5: Final Status and Feedback</option>
                </select>
            </div>
            <div class="table-responsive">
                ...
                <thead class="table-info">
                    ...
                    <th scope="col" class="text-primary py-4" style="width: 20%;">Type of Complaint</th>
                    <th scope="col" class="text-primary py-4" style="width: 10%;">Date</th>
                    <th scope="col" class="text-primary py-4" style="width: 12%;">Status</th>
                    <th scope="col" class="text-primary py-4" style="width: 12%;">Sentiment</th>
                    <th scope="col" class="text-primary py-4" style="width: 12%;">Priority Level</th>
                ...
                <tbody>
                    ...
                    <td class="py-4">Phase 3</td>
                    <td class="py-4"><span class="badge bg-success text-light">Positive</span></td>
                    <td class="py-4">Very High</td>
                    <td class="py-4">
                        <a href="{{ route('edit_complaint') }}" class="btn btn-primary btn-sm px-3 me-2">Edit</a>
                        <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</button>
                    </td>
                    </tr>
                    <tr>
                        <td class="py-4">Aryan, Sabrina</td>
                        <td class="py-4">Environment & Sanitation Issues</td>
                        <td class="py-4">02 / 15 / 25</td>
                        <td class="py-4">Phase 3</td>
                        <td class="py-4"><span class="badge bg-danger text-light">Negative</span></td>
                    ...
                    <tr>
                        ...
                        <td class="py-4"><span class="badge bg-secondary text-black">Neutral</span></td>
