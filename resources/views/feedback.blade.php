              ...
              <table class="table table-hover rounded-4 overflow-hidden shadow">
                <thead class="table-info">
                  <tr>
                    ...
                    <th scope="col" class="text-primary py-4" style="width: 60%;">Feedback Message</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="py-4">The new online system is very user-friendly. Great job!</td>
                    <td class="py-4">09 / 10 / 2024</td>
                  </tr>
                  <tr>
                    <td class="py-4">@jane_smith</td>
                    <td class="py-4">I encountered some issues while submitting my complaint. Please check.</td>
                    <td class="py-4">08 / 15 / 2024</td>
                  </tr>
                  <tr>
                    <td class="py-4">@kevin_anderson</td>
                    <td class="py-4">Thank you for the quick response to my inquiry!</td>
                    <td class="py-4">07 / 20 / 2024</td>
                  </tr>
                  <tr>
                    <td class="py-4">@mary_jane</td>
                    <td class="py-4">The announcements section could use more frequent updates.</td>
                    <td class="py-4">06 / 25 / 2024</td>
                  </tr>
                  <tr>
                    <td class="py-4">@peter_parker</td>
                    <td class="py-4">Great initiative on the cleanup drive. Keep it up!</td>
