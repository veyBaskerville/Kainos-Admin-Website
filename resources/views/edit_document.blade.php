        ...
        <div class="card border-0">
          ...
          <div>
            ...
            <table class="table table-borderless shadow-none">
              <tbody>
                ...
                <tr>
                  ...
                  <td style="width: 80%;">Barangay Residency</td>
                </tr>
                <tr>
                  <th style="width: 20%;">Purpose</th>
                  <td style="width: 80%;">Kailangan ko po ng Barangay Certificate bilang patunay ng aking paninirahan sa Barangay Comembo. Gagamitin ko po ito bilang requirement sa pag-apply ng trabaho.</td>
                </tr>
                <tr>
                ...
                <tr>
                  <th style="width: 20%;" class="text-danger">Valid ID Attachment</th>
                  <td style="width: 80%;">
            ...
            <div class="text-center my-5">
              <a href="{{ route('services.document') }}" class="btn btn-secondary me-2" style="width: 15%;">Cancel</a>
